...
class MyWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('My First APP QT in Python')
        ...
        self.primeiro_menu = self.menu.addMenu('Options')
        self.primeira_acao = self.primeiro_menu.addAction('Change message bar')
